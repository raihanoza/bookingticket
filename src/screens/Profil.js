      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ height: height / 2, justifyContent: "center" }}>
          ...
          >
            ...
            >
              <Text style={[StylesFont.mediumh5, { color: "#535559" }]}>
                Nama Lengkap
              </Text>
              <Text style={[StylesFont.mediumh5, { color: "#535559" }]}>
                {data.name}
        ...
        >
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(
                "http://api.whatsapp.com/send?phone=+6282367285555"
              )
            }
          ...
          <Text>
            Jika ingin tau info lebih lanjut{"\n"}silahkan hubungi Call Center
          </Text>
        </View>
        <View
          style={{ paddingHorizontal: width / 20, marginVertical: 20, gap: 10 }}
        >
